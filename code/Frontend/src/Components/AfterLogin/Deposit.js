...
const Deposit = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const data = {
            ...
            'amount': parseInt(values.amount_to_deposit)
        }
        ...
        const config={
          method : 'post',
          url : 'http://localhost:8080/api/account/deposit',
          headers : {
    ...
    return (
        <div id="particles-js" className={styles.registerContainer}>
            ...
            <div className={styles.formContainer}>
                <h1 className={styles.heading}>Deposit Money</h1>
                <form className={styles.registerForm} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.formGroup}>
                        <label htmlFor="name">Amount to be Deposited :</label>
                        <input
                            id="name"
                            type="text"
                            name="amount_to_deposit"
                            value={values.amount_to_deposit}
                            required
                            onChange={handleChange}
                            className={styles.inputLg}
                    ...
                    <button type="submit" className={styles.btnPrimary}>Deposit</button>
                </form>
            </div>
        </div>
    )
